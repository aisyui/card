			...
			<div v-if="loc === 'te'">
				...
				<div v-for="(ii, index) in rcards.data">
					<div v-show="ii.id !== 0">
						...
						<div v-show="ii.id == 29 || ii.id == 33 || ii.id == 36 || ii.id == 46 || ii.id == 47 || ii.id == 60 || ii.id == 64 || ii.id == 67 || ii.id == 69 || ii.id == 76 || ii.id == 77 || ii.id == 78|| ii.id == 86|| ii.id == 89 || ii.id == 90" class="card-owner-one">
							<p :id="ii.id"><button>id:{{ ii.id }}</button></p>
